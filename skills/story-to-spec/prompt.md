...
```
h2. Auto-generated OpenAPI Specification
...
h3. Breaking Change Analysis
[For each change, list whether it is breaking or additive with explanation]
* [breaking/additive emoji] [description of change]

h3. Generated OpenAPI Specification
{code:yaml}
...
```
h2. OpenAPI Specification — Missing Information
